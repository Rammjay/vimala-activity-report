...
def submit(request):
    if request.method == "POST":
        ...
        try:
            ...
            flb1 = request.POST.get('flb1')
            flb2 = request.POST.get('flb2')
            flb3 = request.POST.get('flb3')
            flb4 = request.POST.get('flb4')
            slb1 = request.POST.get('slb1')
            slb2 = request.POST.get('slb2')
            slb3 = request.POST.get('slb3')
            slb4 = request.POST.get('slb4')
            flnb1 = request.POST.get('flnb1')
            flnb2 = request.POST.get('flnb2')
            flnb3 = request.POST.get('flnb3')
            flnb4 = request.POST.get('flnb4')
            slnb1 = request.POST.get('slnb1')
            slnb2 = request.POST.get('slnb2')
            slnb3 = request.POST.get('slnb3')
            slnb4 = request.POST.get('slnb4')
            sprd = request.POST.get('sprd')
            Dooc = request.POST.get('Dooc')
            Priority = request.POST.get('Priority')
            sprno = request.POST.get('sprno')
            memono = request.POST.get('memono')
            project = request.POST.get('project')
            subsystem = request.POST.get('subsystem')
            asto = request.POST.get('asto')
            iby = request.POST.get('iby')
            aby = request.POST.get('aby')
            ...
            en = Table.objects.filter(spp=spp).first()
